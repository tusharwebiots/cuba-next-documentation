    ...
    <div className="row">
      ...
      <div id="assets" className="col-12">
        ...
        <p>
          ...
          folder structure is maintained. Navigate to <strong>src</strong>{" "}
          folder and the to the <strong>assets</strong> folder. There you can
          find all the assets like Images, scss files, fonts file etc. If you
          need to add any additional assets, we recommend you add it inside the
          assets folder so that the folder structure is maintained.
        </p>
      </div>
      <div id="json" className="col-12">
        ...
        <p>
          To make code sorter and easily modifiable, we get the required data
          from a JSON file and loop through it. This process makes our code mode
        ...
        <p>
          ...
          So the solution is making a JSON file , in which we define an array
          and then loop through it. To add or remove links you can make
          modification in menu.json file.
        </p>
        <p>
          Navigate to <code>{` theme > public > Api_Data`}</code> folder to find all
          JSON files.
        </p>
      </div>
    </div>
